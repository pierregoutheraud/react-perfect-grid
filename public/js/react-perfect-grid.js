(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactPerfectGrid"] = factory();
	else
		root["ReactPerfectGrid"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PerfectGrid = __webpack_require__(171);

	var _PerfectGrid2 = _interopRequireDefault(_PerfectGrid);

	var _jquery = __webpack_require__(175);

	var _jquery2 = _interopRequireDefault(_jquery);

	var _GistEmbed = __webpack_require__(176);

	var _GistEmbed2 = _interopRequireDefault(_GistEmbed);
	...
	function fetchTumblr(tumblr) {
	  ...
	  var url = 'https://api.tumblr.com/v2/blog/' + tumblr + '/posts/photo';
	  url += '?api_key=rG749jGun3EYRBaiV9outPocSgFpXCblfXgakmGCo14yuGwAu7';
	  url += '&limit=' + limit + '&offset=' + (page - 1) * limit;
	  url += '&callback=?';

	  return _jquery2.default.getJSON(url).then(function (res) {
	...
	Promise.all(ps).then(function (array) {
	  ...
	  items[0].over = _react2.default.createElement(
	    'div',
	    { className: "over" },
	  ...
	  items[1].over = _react2.default.createElement(
	    'div',
	    { className: "over" },
	    _react2.default.createElement(
	      'h2',
	  ...
	  _reactDom2.default.render(_react2.default.createElement(Example, { items: items }), document.querySelector('.app'));
	});
	...
	var Example = function (_React$Component) {
	  ...
	  function Example() {
	    ...
	    _this.state = {
	      margins: 0,
	      maxHeight: Math.floor((0, _jquery2.default)(window).height() * .7)
	    };
	    return _this;
	  }
	  ...
	  _createClass(Example, [{
	    ...
	    value: function onChangeMaxHeight(e) {
	      var maxHeight = this.refs.inputMaxHeight.value;
	      this.setState({ maxHeight: maxHeight });
	    }
	  }, {
	    key: 'onChangeMargins',
	    value: function onChangeMargins(e) {
	      var margins = this.refs.inputMargins.value;
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'example__links' },
	            _react2.default.createElement(
	              'a',
	              { href: 'https://github.com/pierregoutheraud/react-perfect-grid', target: '_blank' },
	              'Github'
	            ),
	            _react2.default.createElement('iframe', { src: 'https://ghbtns.com/github-btn.html?user=pierregoutheraud&repo=react-perfect-grid&type=star&count=true', frameBorder: '0', scrolling: '0', width: '100px', height: '20px' })
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'example__usage' },
	          _react2.default.createElement(
	            'h2',
	            null,
	            'Usage'
	          ),
	          _react2.default.createElement(_GistEmbed2.default, { gist: '7f7136927595d34e17ab5faef4689dfc' })
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'example__settings' },
	          _react2.default.createElement(
	            'h2',
	            null,
	            'Demo'
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'fieldset',
	              null,
	              _react2.default.createElement('input', { type: 'range', ref: 'inputMargins', onChange: this.onChangeMargins.bind(this), defaultValue: margins, min: '0', max: '300', step: '1' }),
	              _react2.default.createElement(
	                'p',
	                null,
	                'Margins: ',
	            ...
	            _react2.default.createElement(
	              'fieldset',
	              null,
	              _react2.default.createElement('input', { type: 'range', ref: 'inputMaxHeight', onChange: this.onChangeMaxHeight.bind(this), defaultValue: maxHeight, min: '0', max: '1200', step: '1' }),
	              _react2.default.createElement(
	                'p',
	                null,
	                'Row height: ',
	        ...
	        _react2.default.createElement(_PerfectGrid2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "html {\n  box-sizing: border-box; }\n\n*, *:before, *:after {\n  box-sizing: inherit;\n  margin: 0;\n  padding: 0; }\n\nhtml, body {\n  padding: 0;\n  margin: 0;\n  background-color: white;\n  display: -webkit-box;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-flex: 1;\n  -webkit-flex: 1;\n      -ms-flex: 1;\n          flex: 1;\n  width: 100%;\n  font-family: arial;\n  letter-spacing: 2px; }\n\nh1, h2, h3, h4, h5, h6 {\n  letter-spacing: 3px; }\n\nh2 {\n  font-size: 30px;\n  text-align: center;\n  margin-bottom: 20px; }\n\n::-webkit-scrollbar {\n  display: none; }\n\n.app, .example {\n  display: -webkit-box;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-flex: 1;\n  -webkit-flex: 1;\n      -ms-flex: 1;\n          flex: 1;\n  width: 100%; }\n\n.example {\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n  -webkit-flex-direction: column;\n      -ms-flex-direction: column;\n          flex-direction: column; }\n  .example__title {\n    display: -webkit-box;\n    display: -webkit-flex;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-flex: 1;\n    -webkit-flex: 1;\n        -ms-flex: 1;\n            flex: 1;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n    -webkit-flex-direction: column;\n        -ms-flex-direction: column;\n            flex-direction: column;\n    text-align: center;\n    padding: 100px 0;\n    background-color: #E74C3C;\n    color: white; }\n    .example__title h1 {\n      font-size: 60px;\n      margin-bottom: 10px; }\n  .example__links {\n    display: -webkit-box;\n    display: -webkit-flex;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-align: center;\n    -webkit-align-items: center;\n        -ms-flex-align: center;\n            align-items: center;\n    -webkit-box-pack: center;\n    -webkit-justify-content: center;\n        -ms-flex-pack: center;\n            justify-content: center;\n    margin: 20px 0 0 0; }\n    .example__links > * {\n      margin: 0 10px; }\n    .example__links a {\n      color: white;\n      font-size: 14px; }\n      .example__links a:hover {\n        text-decoration: none; }\n  .example__usage {\n    background-color: #2C3E50;\n    padding: 30px;\n    color: white; }\n    .example__usage h2 {\n      margin-bottom: 20px; }\n    .example__usage .gist {\n      padding: 0 20px;\n      letter-spacing: 0px; }\n  .example__settings {\n    width: 100%;\n    padding: 50px 0; }\n    .example__settings form {\n      display: -webkit-box;\n      display: -webkit-flex;\n      display: -ms-flexbox;\n      display: flex;\n      -webkit-box-align: center;\n      -webkit-align-items: center;\n          -ms-flex-align: center;\n              align-items: center;\n      -webkit-box-pack: center;\n      -webkit-justify-content: center;\n          -ms-flex-pack: center;\n              justify-content: center; }\n    .example__settings input[type=\"range\"] {\n      width: 300px; }\n    .example__settings fieldset {\n      display: -webkit-box;\n      display: -webkit-flex;\n      display: -ms-flexbox;\n      display: flex;\n      -webkit-box-align: center;\n      -webkit-align-items: center;\n          -ms-flex-align: center;\n              align-items: center;\n      -webkit-box-pack: center;\n      -webkit-justify-content: center;\n          -ms-flex-pack: center;\n              justify-content: center;\n      margin: 0 30px;\n      border: none;\n      text-align: center; }\n      .example__settings fieldset p {\n        margin: 15px 0 0 0; }\n        .example__settings fieldset p span {\n          font-weight: bold; }\n\ninput[type=range] {\n  -webkit-appearance: none; }\n\ninput[type=range]::-webkit-slider-runnable-track {\n  height: 5px;\n  background: #ddd;\n  border: none;\n  border-radius: 3px; }\n\ninput[type=range]::-webkit-slider-thumb {\n  -webkit-appearance: none;\n  border: none;\n  height: 15px;\n  width: 15px;\n  border-radius: 50%;\n  background: #999999;\n  margin-top: -5px;\n  box-shadow: 0px 0px 10px 0px rgba(0, 0, 0, 0.1); }\n\ninput[type=range]:focus {\n  outline: none; }\n\ninput[type=range]:focus::-webkit-slider-runnable-track {\n  background: rgba(0, 0, 0, 0.1); }\n\n.perfect-grid__over {\n  cursor: pointer;\n  opacity: 0;\n  -webkit-transition: 300ms ease;\n  transition: 300ms ease; }\n  .perfect-grid__over:hover {\n    opacity: 1; }\n\n.over {\n  padding: 30px;\n  color: white;\n  background-color: rgba(0, 0, 0, 0.2); }\n  .over h2 {\n    font-size: 25px;\n    font-weight: 300;\n    text-align: left; }\n  .over p {\n    font-size: 16px; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PerfectGridItem = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GistEmbed = _react2.default.createClass({
	  displayName: 'GistEmbed',

	  propTypes: {
	    gist: _react2.default.PropTypes.string.isRequired, // e.g. "username/id"
	    file: _react2.default.PropTypes.string // to embed a single specific file from the gist
	  },
	  ...
	  statics: {
	    ...
	    gistCallbackId: 0,
	    nextGistCallback: function nextGistCallback() {
